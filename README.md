...
| Workflow execution | Shell scripts, custom code, workflow frameworks | RabbitMQ as a scheduler and workflow status stored in Cassandra (parallel execution, fault tolerance, incremental computing) |
